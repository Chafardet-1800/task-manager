...
import { AnimationsVariants } from "../models/animations";
import { FormInputConfigModel } from "../models/types";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        bg-white dark:bg-slate-800 dark:text-white rounded p-6 flex flex-col justify-around"
      >
